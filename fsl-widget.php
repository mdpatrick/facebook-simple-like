...
<p><label for="<?php echo $this->get_field_id('pageurl'); ?>">Page URL: <input class="widefat" id="<?php echo $this->get_field_id('pageurl'); ?>" name="<?php echo $this->get_field_name('pageurl'); ?>" type="text" value="<?php echo attribute_escape($pageurl); ?>" /></label></p>
